...
****/
int Media(int valor1, int valor2){ /*o tipo da função e as suas variáveis foram definidas como "int" e, portanto,
                                    ao chamar essa função a saída será um resultado do tipo inteiro*/
